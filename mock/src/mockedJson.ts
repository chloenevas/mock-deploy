...
incomeRow1.push("state", "data type", "average weekly earnings", "number of workers", "earnings disparity", "employed percent");
incomeRow2.push("ri", "white", "\" $1,058.47 \"", "395773.6521", "  $1.00 ", " 75%");
incomeRow3.push("ri", "black", "  $770.26 ", " 30424.80376", "  $0.73 ", " 6%");
incomeRow4.push("ri", " native american/american indian", "  $471.07 ", " 2315.505646", "  $0.45", " 0%")
incomeRow5.push("ri", " asian-pacific islander", "\" $1,080.09 \"", " 18956.71657", "  $1.02 ", " 4%")
incomeRow6.push("ri", " hispanic/latino", "  $673.14 ", " 74596.18851", "  $0.64 ", " 14%")
incomeRow7.push("ri"," multiracial","  $971.89 "," 8883.049171","  $0.92 "," 2%")
incomeOutput.push(incomeRow1, incomeRow2, incomeRow3, incomeRow4, incomeRow5, incomeRow6, incomeRow7);
...
starsRow6.push("70667", " Proxima Centauri", " -0.47175", " -0.36132", " -1.15037");
starsRow7.push("71454", " Rigel Kentaurus B", " -0.50359", " -0.42128", " -1.1767")
starsRow8.push("71457"," Rigel Kentaurus A"," -0.50362"," -0.42139"," -1.17665")
